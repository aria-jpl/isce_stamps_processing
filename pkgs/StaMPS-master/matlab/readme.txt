 ...
 the application)
   -to run the shell script, type
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_stamps.sh /mathworks/home/application/v96
...
-MCRInstaller.zip 
    ...
    Deployment Tool.
-The Macintosh bundle directory structure stamps.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r stamps.zip stamps.app
    or the tar command 
    tar -cvf stamps.tar stamps.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v96/runtime/maci64:MR/v96/sys/os/maci64:MR/v96/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_stamps.sh 
